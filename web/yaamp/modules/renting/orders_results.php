...
foreach ($list as $job)
{
    ...
    {
        $percent = 100;
        if ($hashrate) $percent = round($hashrate_bad / $hashrate * 100, 1) . '%';
...
else if ($renter->balance > 0) echo "<br><button class='main-submit-button' onclick='javascript:order_new()'>New Job</button>";
else echo "<p style='padding: 10px;'>You have to fund your account by sending bitcoin to your deposit address before you can start creating mining jobs.</p>";
