...
class YiiBase
{
	...
	{
		// yaamp patch: phpCAS classes are loaded by their own autoloader
		if(strpos($className, 'CAS_') !== false) return false;
		...
		else
		{
			...
			if(strpos($className,'\\')===false)  // class without namespace
			{
				if(self::$enableIncludePath===false)
				{
					...
					// yaamp patch: models live in the yaamp module directories
