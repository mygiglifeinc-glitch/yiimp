// Imported from Raptoreum Core, github.com/Raptor3um/raptoreum src/cryptonote/c_groestl.c
...
static const uint8_t shift_Values[2][8] = {{0,1,2,3,4,5,6,7},{1,3,5,7,0,2,4,6}};

static const uint8_t indices_cyclic[15] = {0,1,2,3,4,5,6,7,0,1,2,3,4,5,6};
